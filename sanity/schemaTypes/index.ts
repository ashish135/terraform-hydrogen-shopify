...
import {featuredProduct} from './objects/module/featureProduct'
...
const documents = [collectionType, colorThemeType, pageType, productType, productVariantType, featuredProduct]
